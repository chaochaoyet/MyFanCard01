...
bool HelloWorld::init()
{
	...
	do 
	{
		...
		CC_BREAK_IF(! CCColorLayer::initWithColor( ccc4(125,125,125,125) ) );
		...
		CCImage *pcImg=new CCImage();
		CCImage::ETextAlign et=CCImage::kAlignCenter;
		pcImg->initWithString("player",0,0,et,"Artial",30);
  		CCTexture2D *pTexture=new CCTexture2D();
 		pTexture->initWithImage(pcImg);
		CCSprite *player = CCSprite::spriteWithTexture(pTexture,CCRectMake(0, 0, 100, 100));
